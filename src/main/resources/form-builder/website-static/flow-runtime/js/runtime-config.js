...
// flow runtime is what every Form Builder app needs whether or not it has a workspace.
//
...
// Form Builder apps on one origin sharing `taxpert:factGraph` in sessionStorage. head.html now renders
...
//
// The server layer arrives as `<meta name="form-builder:*">` rather than as an inline module that calls
...
/**
 * The namespaced key for `name`, so two Form Builder apps served from one origin do not share
 * sessionStorage.
 *
