...
// import that one and re-export it, which is what made the flow runtime — a thing every Formative
// app needs — depend on the workspace, a thing no app needs.
//
// Sharing one copy is not available here, in either direction. Formative ships as a Scala jar, not
// an npm package, so taxpert cannot `import` from it; and a relative path into `vendor/formative/`
